...
{
    public partial class Bf4SoldierPage : PhoneApplicationPage
    {
        ...
        private readonly Bf4SoldierViewModel _soldierViewModel;

        public Bf4SoldierPage()
        {
            InitializeComponent();
            _soldierViewModel = DataContext as Bf4SoldierViewModel;
        ...
        {
            ToggleUIState(false);
            Messenger.Default.Send(new BattlelogCredentialsAcceptedMessage(ViewModelLocator.Main.Email, SupportedGame.Battlefield4, true));
        }
